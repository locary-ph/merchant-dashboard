...
const Products = () => {
  ...
  const showAddProduct = (status) => event => {
    event.preventDefault();
    setAddProduct(status);
  }
        ...
        <>
          <Row className="mb-4">
            ...
            >
              ...
              <Button className="w-lg-25 w-100 d-block" color="warning" outline type="button" onClick={showAddProduct("true")}>
